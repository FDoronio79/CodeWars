...
def is_valid_walk(walk):
    # the key to this is checking to return back to the start
    # how we achieve this is by comparing the counts of 'n' to 's' and 'e' to 'w'
    # if count of 'n' and 's' are equal and count of 'e' and 'w' are equal you are back to the beginning
    if len(walk) == 10 and (
        walk.count('n') == walk.count('s') and walk.count('e') == walk.count('w')):
        return True
    return False
